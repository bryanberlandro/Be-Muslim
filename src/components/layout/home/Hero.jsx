...
export function Hero(){
    return(
        <>
        <div className="w-full rounded-xl relative h-96 flex flex-col justify-between md:h-[400px]">
            ...
            <div className="relative pt-24 px-[5%] w-[90%]">
                <h1 className="text-2xl font-bold mt-1 md:text-4xl"><span className="text-emerald-600 font-bold">Be Muslim</span>, Your Journey with Quran, Hadith, and Prayer.</h1>
            </div>
            <div className="flex mt-8 mb-4 gap-2 relative items-center px-[5%] md:mt-10 md:mb-6">
                <div className="flex">
